// Interactive Chat Widget for n8n with Mobile Responsiveness
(function() {
    ...
    // Apply widget styles with mobile responsiveness
    ...
    widgetStyles.textContent = `
        ...
        @media (max-width: 768px) {
            ...
            .chat-assist-widget .chat-launcher.chat-open {
        ...
        .chat-assist-widget .chat-refresh-btn,
        ...
        .chat-assist-widget .chat-refresh-btn:hover,
        .chat-assist-widget .chat-close-btn:hover {
            background: rgba(255, 255, 255, 0.3);
            transform: scale(1.1);
        }

        .chat-assist-widget .chat-refresh-btn svg {
            width: 16px;
            height: 16px;
        }
        ...
        .chat-assist-widget .chat-launcher.chat-open .chat-launcher-text {
            opacity: 0;
            width: 0;
            overflow: hidden;
        }
        ...
        .chat-assist-widget .error-text.show {
            display: block;
        }
    ...
    const defaultSettings = {
        webhook: {
            url: 'https://anthonyc.app.n8n.cloud/webhook/c1dd25e8-087e-4ae9-bc5d-aee202772af6/chat',
            route: 'general'
        },
        branding: {
    ...
    // Create welcome screen with registration form
    const welcomeScreenHTML = `
        <div class="chat-header">
            <img class="chat-header-logo" src="${settings.branding.logo}" alt="${settings.branding.name}">
            <span class="chat-header-title">${settings.branding.name}</span>
            <div class="chat-header-buttons">
                <button class="chat-refresh-btn" title="Refresh conversation">
    ...
    const chatInterfaceHTML = `
        <div class="chat-body">
            ...
            <div class="chat-controls">
                <textarea class="chat-textarea" id="chat-message-input" name="message" placeholder="Type your message here..." rows="1"></textarea>
    ...
    function handleRefresh() {
        // Only clear the conversation if we're in an active chat
        if (chatBody.classList.contains('active')) {
            ...
            confirmation.className = 'chat-bubble bot-bubble';
            confirmation.textContent = "Conversation refreshed. You can start a new conversation.";
            messagesContainer.appendChild(confirmation);
    ...
    closeButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            launchButton.classList.remove('chat-open');
            
            // Reset icon when chat is closed
            const icon = launchButton.querySelector('svg');
            icon.innerHTML = '<path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path>';
        });
    });
